...
Repository _$RepositoryFromJson(Map<String, dynamic> json) {
  ...
  if (null != repository.size && repository.size > 0 ) {
        repository.repositorySize = '${(repository.size / 1024.0).toInt()}M';
  }

  if (null != repository.createdAt){
        repository.createdAtString = CommonUtils.getNewsTimeStr(repository.createdAt);
  }

  if (null != repository.pushedAt){
        repository.pushedAtString = CommonUtils.getNewsTimeStr(repository.pushedAt);
  }
