class User {
	...
	User({this.gistsUrl, this.reposUrl, this.twoFactorAuthentication, this.followingUrl, this.bio, this.createdAt, this.login, this.type, this.blog, this.privateGists, this.totalPrivateRepos, this.subscriptionsUrl, this.updatedAt, this.siteAdmin, this.diskUsage, this.collaborators, this.company, this.ownedPrivateRepos, this.id, this.publicRepos, this.gravatarId, this.plan, this.email, this.organizationsUrl, this.hireable, this.starredUrl, this.followersUrl, this.publicGists, this.url, this.receivedEventsUrl, this.followers, this.avatarUrl, this.eventsUrl, this.htmlUrl, this.following, this.name, this.location, this.nodeId});
